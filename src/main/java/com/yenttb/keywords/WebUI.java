...
public class WebUI {
    ...
    public static void selectItemInDrodown(By dropdown, By selectedItem) {
        ...
        sleep(STEP_TIME);
        DriverManager.getDriver().findElement(dropdown).click();
        LogUtils.info("Click element " + dropdown);
        ExtentTestManager.logMessage(Status.PASS, "Click on element " + dropdown);
        DriverManager.getDriver().findElement(selectedItem).click();
        LogUtils.info("Click element " + selectedItem);
        ExtentTestManager.logMessage(Status.PASS, "Click on element " + selectedItem);
    ...
    public static void waitForElementVisible(By by) {
        try {
            WebDriverWait wait = new WebDriverWait(DriverManager.getDriver(), Duration.ofSeconds(TIMEOUT), Duration.ofMillis(30000));
